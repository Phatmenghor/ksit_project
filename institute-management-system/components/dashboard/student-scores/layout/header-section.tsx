  ...
  return (
    <Card className="shadow-md">
      <CardContent className="p-4 sm:p-6 space-y-3">
        ...
        {/* Course Details */}
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 sm:p-5 space-y-4 shadow-sm hover:shadow-md transition-shadow duration-200">
          {/* Header: Course code + name + summary */}
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            <div className="flex gap-3 sm:gap-4 flex-1 min-w-0">
              {/* Colored border indicator */}
              <div className="w-1.5 rounded-full bg-amber-500 flex-shrink-0" />
            ...
            {/* Right info: day, subject, total hours, credits */}
            <div className="text-xs sm:text-sm font-medium text-amber-700 whitespace-nowrap">
          ...
          {/* Info items: time, teacher, location */}
