...
export default function ProfileUploadCard({ fieldName = "profileUrl" }: ProfileUploadCardProps) {
  ...
  const profileUrl = watch(fieldName);
      ...
      reader.onloadend = async () => {
        ...
        try {
          ...
          if (response?.imageUrl) {
            ...
            setValue(fieldName, response.imageUrl, { shouldValidate: true });
