...
public class AttendanceDto {
    ...
    // ===== NEW FIELDS FOR ATTENDANCE SCORE CALCULATION =====

    // Total sessions conducted (finalized) for this schedule
    private Integer totalSessionsConducted;

    // Total sessions this student attended (PRESENT)
    private Integer sessionsAttended;

    // Attendance percentage (0-100)
    private BigDecimal attendancePercentage;

    // Attendance score based on configuration (e.g., if 10% weight, max 10 points)
    private BigDecimal attendanceScore;

    // Maximum possible attendance score from configuration
    private Integer maxAttendanceScore;

    // Description of attendance status
    private String attendanceScoreDescription;
}