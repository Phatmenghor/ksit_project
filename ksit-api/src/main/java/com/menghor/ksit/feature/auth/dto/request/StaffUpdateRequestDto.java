...
public class StaffUpdateRequestDto {
    ...
    @JsonProperty("teachersProfessionalRank") // Maps from JSON "teachersProfessionalRank"
    @Builder.Default
    private List<TeachersProfessionalRankDto> teachersProfessionalRanks = new ArrayList<>();
    
    @JsonProperty("teacherExperience") // Maps from JSON "teacherExperience"
    @Builder.Default
    private List<TeacherExperienceDto> teacherExperiences = new ArrayList<>();
    
    @JsonProperty("teacherPraiseOrCriticism") // Maps from JSON "teacherPraiseOrCriticism"
    @Builder.Default
    private List<TeacherPraiseOrCriticismDto> teacherPraiseOrCriticisms = new ArrayList<>();
    
    @JsonProperty("teacherEducation") // Maps from JSON "teacherEducation"
    @Builder.Default
    private List<TeacherEducationDto> teacherEducations = new ArrayList<>();
    
    @JsonProperty("teacherVocational") // Maps from JSON "teacherVocational"
    @Builder.Default
    private List<TeacherVocationalDto> teacherVocationals = new ArrayList<>();
    
    @JsonProperty("teacherShortCourse") // Maps from JSON "teacherShortCourse"
    @Builder.Default
    private List<TeacherShortCourseDto> teacherShortCourses = new ArrayList<>();
    
    @JsonProperty("teacherLanguage") // Maps from JSON "teacherLanguage"
    @Builder.Default
    private List<TeacherLanguageDto> teacherLanguages = new ArrayList<>();
    
    @JsonProperty("teacherFamily") // Maps from JSON "teacherFamily"
    @Builder.Default
