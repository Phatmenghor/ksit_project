...
@Data
@Entity
@Table(name = "survey_sections", indexes = {
    @Index(name = "idx_survey_section_survey_id", columnList = "survey_id"),
    @Index(name = "idx_survey_section_status", columnList = "status"),
    @Index(name = "idx_survey_section_display_order", columnList = "displayOrder")
})
