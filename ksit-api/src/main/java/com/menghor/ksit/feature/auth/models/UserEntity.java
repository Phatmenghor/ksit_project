...
@Table(name = "users", indexes = {
    ...
    @Index(name = "idx_student_status", columnList = "studentStatus"),
    ...
    @Index(name = "idx_identify_number", columnList = "identify_number"),
    @Index(name = "idx_user_status_class", columnList = "status, class_id"),
    @Index(name = "idx_user_status_dept", columnList = "status, department_id")
})
@Data
@NoArgsConstructor
