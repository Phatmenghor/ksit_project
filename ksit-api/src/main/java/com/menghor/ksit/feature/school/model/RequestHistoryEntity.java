...
@Table(name = "request_history", indexes = {
    @Index(name = "idx_request_history_request_id", columnList = "request_id"),
    @Index(name = "idx_request_history_action_user_id", columnList = "action_user_id"),
    @Index(name = "idx_request_history_from_status", columnList = "fromStatus"),
    @Index(name = "idx_request_history_to_status", columnList = "toStatus")
})
