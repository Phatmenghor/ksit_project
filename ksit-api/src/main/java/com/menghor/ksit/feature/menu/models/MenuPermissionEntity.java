...
@Table(name = "menu_permissions",
       ...
       indexes = {
           @Index(name = "idx_menu_perm_menu_item_id", columnList = "menu_item_id"),
           @Index(name = "idx_menu_perm_role", columnList = "role_name"),
           @Index(name = "idx_menu_perm_user_id", columnList = "user_id"),
           @Index(name = "idx_menu_perm_status", columnList = "status"),
           @Index(name = "idx_menu_perm_can_view", columnList = "can_view")
       })
