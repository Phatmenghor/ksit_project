...
@Table(name = "survey_questions", indexes = {
    @Index(name = "idx_survey_question_section_id", columnList = "section_id"),
    @Index(name = "idx_survey_question_status", columnList = "status"),
    @Index(name = "idx_survey_question_type", columnList = "questionType"),
    @Index(name = "idx_survey_question_display_order", columnList = "displayOrder")
})
