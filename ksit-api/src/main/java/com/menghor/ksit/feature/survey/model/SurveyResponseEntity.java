...
@Table(name = "survey_responses",
        ...
        indexes = {
                ...
                @Index(name = "idx_survey_response_schedule_id", columnList = "schedule_id"),
                @Index(name = "idx_survey_response_status", columnList = "status"),
                @Index(name = "idx_survey_response_completed", columnList = "isCompleted"),
                @Index(name = "idx_survey_response_submitted", columnList = "submittedAt")
        })
