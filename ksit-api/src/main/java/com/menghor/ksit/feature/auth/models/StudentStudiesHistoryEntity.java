...
@Data
@Entity
@Table(name = "student_studies_history", indexes = {
    @Index(name = "idx_student_studies_user_id", columnList = "user_id"),
    @Index(name = "idx_student_studies_type", columnList = "typeStudies")
})
