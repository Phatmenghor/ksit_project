...
//        log.info("🚀 Starting DefaultMenuInitializer...");
//
//        try {
//
//            // Step 1: Initialize menu items and permissions
//            initializeMenusAndPermissions();
//
//            // Step 2: Initialize menu permissions for all existing users
//            initializeMenuPermissionsForAllUsersWithErrorHandling();
//
//            log.info("✅ DefaultMenuInitializer completed successfully");
//
//        } catch (Exception e) {
...
//
//    /**
//     * Step 2: Initialize menu items and permissions
//     */
//    private void initializeMenusAndPermissions() {
//        log.info("🎯 Initializing menu items and permissions...");
//
...
//        } else {
//            log.info("Menu items already exist, skipping menu creation");
//        }
//    }
//
//    /**
//     * Step 3: AUTO-ASSIGN DEFAULT PERMISSIONS TO ALL EXISTING USERS WITH ERROR HANDLING
//     */
...
//            // Create role-based permissions for fallback with UPDATED permissions
...
//                            List.of(RoleEnum.DEVELOPER, RoleEnum.ADMIN)));
//                    break;
//                // ✅ UPDATED: Students management - Staff level and above only (no TEACHER)
//                case "STUDENTS":
...
//                    break;
//                // Attendance - Teacher level and above
//                case "ATTENDANCE":
//                case "CLASS_SCHEDULE":
...
//                    break;
//                // Survey - Teacher level and above
//                case "SURVEY":
//                case "RESULT_LIST":
//                case "MANAGE_QA":
...
//                            List.of(RoleEnum.DEVELOPER, RoleEnum.ADMIN, RoleEnum.STAFF, RoleEnum.TEACHER, RoleEnum.STUDENT)));
//                    break;
//                // Score management - Teacher level and above
...
//                            List.of(RoleEnum.DEVELOPER, RoleEnum.ADMIN, RoleEnum.STAFF, RoleEnum.TEACHER, RoleEnum.STUDENT)));
//                    break;
//                // ✅ UPDATED: Manage Schedule - Staff level and above (including STAFF)
...
//                            List.of(RoleEnum.DEVELOPER, RoleEnum.ADMIN, RoleEnum.STAFF, RoleEnum.TEACHER, RoleEnum.STUDENT)));
//                    break;
//                // ✅ UPDATED: Role Permission - Admin and Developer (not just Developer)
