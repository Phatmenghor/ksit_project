-- =========================================================
--  FULL MENU SEED  –  run in pgAdmin query tool
--  Clears existing menu data and re-inserts from scratch.
--  Tables must already exist (created by Spring JPA on startup).
-- =========================================================
...
SELECT id, 'STUDENT',   NULL, true, 1, 'ACTIVE', NOW() FROM menu_items WHERE code='dashboard'
UNION ALL
SELECT id, 'TEACHER',   NULL, true, 2, 'ACTIVE', NOW() FROM menu_items WHERE code='dashboard'
UNION ALL
SELECT id, 'STAFF',     NULL, true, 3, 'ACTIVE', NOW() FROM menu_items WHERE code='dashboard'
UNION ALL
SELECT id, 'ADMIN',     NULL, true, 4, 'ACTIVE', NOW() FROM menu_items WHERE code='dashboard'
UNION ALL
SELECT id, 'DEVELOPER', NULL, true, 5, 'ACTIVE', NOW() FROM menu_items WHERE code='dashboard';
...
INSERT INTO menu_permissions (menu_item_id, role_name, user_id, can_view, display_order, status, created_at)
SELECT id, 'STUDENT', NULL, true, 1, 'ACTIVE', NOW()
